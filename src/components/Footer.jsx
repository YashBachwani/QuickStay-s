  ...
  return (
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5 text-sm'>
        <p>
          © {new Date().getFullYear()} QuickStay — All rights reserved by{' '}
          <span className='font-medium text-gray-700'>Yash Bachwani</span>
        </p>

        <div className='flex flex-col md:flex-row items-center gap-4'>
          <p className='text-gray-500'>
            Developed by <span className='font-medium text-gray-700'>Yash Bachwani</span>
          </p>
